...
You need to add also ELM.h and Preprocess.c and Preprocess.h from [`Micro-LM`](https://github.com/Edge-Learning-Machine/Micro-LM).
...
## License
This project is licensed under the MIT License - see the [LICENSE](https://github.com/Edge-Learning-Machine/Desk-LM/blob/master/LICENSE) file for details
